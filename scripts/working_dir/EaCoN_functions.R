          ...
          return.data = FALSE, write.data = TRUE, plot = TRUE, force = FALSE, oschp_file = NULL) 
{
    ...
    ## process CEL files on linux or with APT itself since function apt.oncoscan.process() is from R package apt.oncoscan.2.4.0 which is 16-bit on windows (meaning it doesn't work)
...
ASCN.ASCAT function (data = NULL, gammaRange = c(0.35, 0.95), nsubthread = 1, 
