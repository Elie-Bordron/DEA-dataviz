...
plot(y=raw$Log2Ratio..5.LD.OSCHP., x=raw$absPos, pch=20, main="Raw data", cex=0.01, xlab="Genomic position (bp)", ylab="Log Ratio")
plot(y=adj$Log2Ratio, x=adj$absPos, pch=20, main="Adjusted data", cex=0.01, xlab="Genomic position (bp)", ylab="Log Ratio")
...
plot(y=segDf$Segm , x=segDf$absPos, pch=20, main=paste0(sampleName," Segmented data"), cex=0.01, xlab="Genomic position (bp)", ylab="Log Ratio")
